...
::: {.notes}
- Es decir, $2\log_2 n$ es el $k$ mas grande para el que esperamos ver al menos un clique de tamaño $k$.
:::
...
\\
& u_1 \approx \ones \qquad \lambda_1 \approx \frac{n}{2}
\end{align}
:::
