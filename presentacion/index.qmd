...
format:
  revealjs:
    ...
    default-timing: 89 # 40*60 / (28-1) (no cuento slide referencias)
    multiplex:
...
- Grado esperado de vertices (n-1) / 2
...
- sin θ <= 4√n / k
- Por que vale este analisis de E(A) en A?
1. Teoria de Perturbaciones
2. sin θ acotado => La rotación de autovectores es tan pequeña que la gran mayoría de los nodos del clique se mantienen en las posiciones superiores del autovector v_2
3. Se pueden calcular los autovectores reales y comprobar que son parecidos
4. Se puede aplicar el algoritmo y comprobar que funciona.
:::
